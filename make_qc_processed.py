...
overlay_movie_path = str(qc_dir / "overlay.mp4")
registered_movie_path = str(qc_dir / "registered.mp4")
stills_dir = qc_dir / "stills_overlay"
registered_stills_dir = qc_dir / "stills_registered"
gif_path = str(qc_dir / "rotating_mip.gif")
